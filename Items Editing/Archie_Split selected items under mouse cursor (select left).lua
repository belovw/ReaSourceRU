-- @description Split selected items under mouse cursor (select left)
-- @version 1.0
-- @author Archie
...
--    init
 ...
 --=================================================]]
     ...
     local function Split_item_sel_left (item,Pos) 
         local TrackNumber_  
     ...
     local TrackNumber = Split_item_sel_left(item,Pos) 
